...
GENERIC_ERROR_MSG = "Hids Internal Error. See log for more detail"
HIDS_VERSION = 'current' if wazuh_full_version == '' else '.'.join(wazuh_full_version.split('.')[:2]).lstrip('v')
...
class WazuhException(Exception):
    ...
    ERRORS = {
        ...
        1000: {'message': 'Hids Internal Error',
               'remediation': 'Please, check `HIDS_HOME/logs/ossec.log`, `HIDS_HOME/logs/cluster.log` and '
                              '`HIDS_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Hids directories'},
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Hids to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Hids directories'},
        1017: 'Some Hids daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        ...
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `HIDS_PATH/bin/hids-logtest -t` to check your configuration'},
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation  '
                              'to get more information about configuration sections'},
        ...
        1116: {'message': "Requested component configuration does not exist",
               'remediation': f"Please, visit the official documentationto check available component configurations"
               },
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in HIDS_PATH/configuration/api.yaml'},
        1123: {
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue please enable the remote commands in the API settings '},
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `HIDS_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },

        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `HIDS_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation'
        ...
        1204: {'message': 'Operation not implemented',
               'remediation': 'Please contact us: [official repository]https://www.zhiannet.com'
               },
        1205: {'message': 'Requirement not valid',
               'remediation': 'Please indicate one of the following values:'
               },
        1206: {'message': 'Duplicated rule ID',
               'remediation': f'Please check your configuration, two or more rules have the same ID, visit the official documentation'
                              ' to get more information about how to configure the rules'
               },
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, contact us at [official repository](https://www.zhiannet.com)'
               },
        ...
        1600: {'message': 'There is no database for selected agent with id',
               'remediation': 'Please, upgrade hids to v3.7.0 or newer. Visit '
                              ' to obtain more information on upgrading Hids'
               },
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit '
        ...
        1735: {'message': 'Agent version is not compatible with this feature',
               'remediation': 'Please update the agent, in case the problem persists contact us at'
               },
        ...
        1739: {'message': 'Error getting agents group sync',
               'remediation': f'Please check that the agent and the group are correctly created. Official documentation'
               },
        ...
        1743: 'Error running Hids syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `HIDS_HOME/etc/ossec.conf`"},
        ...
        2003: {'message': 'Error in hidsdb request',
        ...
        2006: {'message': 'Received JSON from Hids DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Hids DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Hids service to restore the RBAC database to default'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `HIDS_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'Hids is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, try again in the master node: {MASTER_IP}',
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at HIDS_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `hids-manager` service.'},
        3024: "Length of command exceeds limit defined in hids.cluster.common.Handler.cmd_len.",
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names]"
                              " and restart the `hids-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name]"
                              " and restart the `hids-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name]"
                              " in the worker configuration to match the master's and restart the `hids-manager` service"},
        ...
        3033: "Payload length exceeds limit defined in hids.cluster.common.Handler.request_chunk.",
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              f"For more information on how to set up permissions, please visit"},
        ...
        4008: {'message': 'The specified resource is required for a correct Hids\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit'},
        ...
        4500: {'message': 'The specified resources are invalid',
               'remediation': 'Please, make sure permissions are properly defined, '
                              f'for more information on setting up permissions'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (hids) or '
        ...
        6001: {'message': 'Maximum number of request per minute reached',
               'remediation': f'This limit can be changed in security.yaml file.'},
        6002: {'message': 'The body type is not the one specified in the content-type'},
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: HIDS_PATH/api/configuration/security/jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint'},
    ...
    def __init__(self, code, extra_message=None, extra_remediation=None, cmd_error=False, dapi_errors=None, title=None,
        ...
        :param dapi_errors: dict with details about node and logfile. I.e.:
                            {'master-node': {'error': 'Hids Internal error',
                                             'logfile': HIDS_HOME/logs/api.log}
                            }
...
class WazuhInternalError(WazuhException):
    ...
    _default_title = "Hids Internal Error"
...
class WazuhClusterError(WazuhError):
    ...
    """
    _default_type = "about:blank"
    _default_title = "Hids Cluster Error"
