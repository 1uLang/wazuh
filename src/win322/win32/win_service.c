...
#ifndef ARGV0
#define ARGV0 "hids-agent"
#endif

static LPTSTR g_lpszServiceName        = "HidsSvc";
static LPTSTR g_lpszServiceDisplayName = "Hids";
static LPTSTR g_lpszServiceDescription = "Hids Windows Agent";
