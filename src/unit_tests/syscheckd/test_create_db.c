...
static void test_fim_scan_db_full_double_scan(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":50000,\"alert_type\":\"full\"}");
...
static void test_fim_scan_db_free(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":1000,\"alert_type\":\"normal\"}");
    will_return(__wrap_send_log_msg, 1);
...
#endif
    expect_string(__wrap__minfo, formatted_msg, "(6038): Sending DB back to normal alert.");
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":0,\"alert_type\":\"normal\"}");
    will_return(__wrap_send_log_msg, 1);
...
static void test_fim_check_db_state_empty_to_90_percentage(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":46000,\"alert_type\":\"90_percentage\"}");
    will_return(__wrap_send_log_msg, 1);
...
static void test_fim_check_db_state_empty_to_80_percentage(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":41000,\"alert_type\":\"80_percentage\"}");
    will_return(__wrap_send_log_msg, 1);
...
#endif
    expect_string(__wrap__minfo, formatted_msg, "(6038): Sending DB back to normal alert.");
    expect_string(__wrap_send_log_msg, msg, "hids: FIM DB: {\"file_limit\":50000,\"file_count\":10000,\"alert_type\":\"normal\"}");
    will_return(__wrap_send_log_msg, 1);
