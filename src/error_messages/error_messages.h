...
#define HOME_ERROR    "(1108): Unable to find hids install directory. Export it to HIDS_HOME environment variable."
...
#define DB_COMPILED           "(5207): hids not compiled with support for '%s'."
...
#define VU_INV_HIDSDB_RES          "(5530): Invalid response from hids-db: '%s'"
...
#define VU_HIDS_DB_CPE_IN_ERROR    "(5539): Could not insert the CPEs from the agent '%.3d' into the database."
...
#define VU_WCPE_GET_TIMEST_ERROR    "(5554): Could not get the update date of the hids CPE dictionary."
...
#define VU_WCPE_GET_VERFORMAT_ERROR "(5557): Could not get the version format of the hids CPE dictionary."
...
#define VU_VER_INVALID_FORMAT       "(5588): Invalid format of hids version for agent '%.3d'"
#define VU_VER_READING_ERROR        "(5589): Couldn't read hids version for agent '%.3d'"
...
#define LOGTEST_ERROR_INV_CONF                      "(7304): Invalid hids-logtest configuration"
...
#define HIDS_HOMEDIR "Hids home directory: %s"
...
#define OS_NORMAL_BUFFER  "hids: Agent buffer: 'normal'."
#define OS_WARN_BUFFER  "hids: Agent buffer: '%d%%'."
#define OS_FULL_BUFFER  "hids: Agent buffer: 'full'."
#define OS_FLOOD_BUFFER "hids: Agent buffer: 'flooded'."
